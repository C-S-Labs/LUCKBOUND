...
_223 text files, 169 binary assets. Regenerate with `python tools/gen_index.py`; CI refuses a stale index. Format: `path` (lines) - description; then `symbol:line` for every function / top-level entry / doc heading. The date after `·` is the file's last commit (history: `git log --format="%cs %s" -- <path>`)._
...
- `docs/PROTOTYPE_BUILD_SPEC.md` (1114) - LUCKBOUND — Prototype Build Specification · 2026-09-26
...
- `docs/STATUS.md` (188) - LUCKBOUND — Project Status · 2026-09-26
...
- `docs/WORKLOG.md` (5101) - LUCKBOUND — Work Log · 2026-09-26
