...
| `Content/Chunks/SkyCitadel` | ✅ 12 pieces, **FBXs exported** — [`SKY_CITADEL.md`](SKY_CITADEL.md) |
...
| Actual meshes | ⏳ all 20 are `PLACEHOLDER`; Sky Citadel's 12 are exported as FBX |
...
(asserted over 200). It is also the first kit with a real quarter turn. Its pieces are the first in the project generated by a script and
