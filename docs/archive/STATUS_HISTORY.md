# STATUS history (archived 2026-09-25)

> The full STATUS.md as it stood before it was slimmed. Closed items, walk reports and long open-item notes live here. **Read only a section you need** (search `INDEX_MAP.md` for its headings). Current state is `docs/STATUS.md`.
